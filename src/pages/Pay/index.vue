  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <el-button type="primary" @click="open">立即支付</el-button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
  ...
  methods: {
    async getPayInfo() {
      ...
      if (result.code == 200) {
        ...
        console.warn(
          "Get pay info failed, error code+" +
            result.code +
            ":" +
            result.message
        );
    ...
    async open() {
      ...
      if (this.payInfo.codeUrl) {
        console.warn("No QRCode available");
      } else {
        url = await QRCode.toDataURL("test text for now");
      }

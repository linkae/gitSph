...
export default {
  ...
  methods: {
    changeActive(attrValue, spuSaleAttrValueList) {
      let playload = { attrValue, spuSaleAttrValueList };
      this.$store.dispatch("changeActive", playload);
    },
    changeSkuNum(e) {
    ...
    addShopCart() {
      ...
      this.$store
        ...
        .then((resolve) => {
          // 本地存储/会话存储，一般存储的是字符串（对象类型不能直接存，要转为字符串）
